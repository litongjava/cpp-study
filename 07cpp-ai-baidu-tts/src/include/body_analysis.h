...
public:
   ...
   * options 可选参数:
   */
  Json::Value body_analysis(std::string const & image,
    ...
    Json::Value result = this->request(_body_analysis, null, data, null);
   ...
   */
  Json::Value body_attr(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_body_attr, null, data, null);
   ...
   */
  Json::Value body_num(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_body_num, null, data, null);
