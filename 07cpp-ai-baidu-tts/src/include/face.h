...
public:
  ...
  std::string _detect = "https://aip.baidubce.com/rest/2.0/face/v3/detect";

  std::string _search = "https://aip.baidubce.com/rest/2.0/face/v3/search";
  ...
  Face(const std::string & app_id, const std::string & ak,
      const std::string & sk) :
   ...
   */
  Json::Value detect(std::string const & image, std::string const & image_type,
    ...
    Json::Value result = this->request(_detect, null, data.toStyledString(),
        null);
   ...
   */
  Json::Value search(std::string const & image, std::string const & image_type,
    ...
    Json::Value result = this->request(_search, null, data.toStyledString(),
        null);
  ...
  Json::Value user_add(std::string const & image,
      std::string const & image_type, std::string const & group_id,
    ...
    Json::Value result = this->request(_user_add, null, data.toStyledString(),
        null);
  ...
  Json::Value user_update(std::string const & image,
    ...
    Json::Value result = this->request(_user_update, null,
        data.toStyledString(), null);
   ...
   * options 可选参数:
   */
  Json::Value face_delete(std::string const & user_id,
      std::string const & group_id, std::string const & face_token,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_face_delete, null,
        data.toStyledString(), null);
   ...
   * options 可选参数:
   */
  Json::Value user_get(std::string const & user_id,
    ...
    Json::Value result = this->request(_user_get, null, data.toStyledString(),
        null);
   ...
   * options 可选参数:
   */
  Json::Value face_getlist(std::string const & user_id,
      std::string const & group_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_face_getlist, null,
        data.toStyledString(), null);
   ...
   */
  Json::Value group_getusers(std::string const & group_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_group_getusers, null,
        data.toStyledString(), null);
   ...
   */
  Json::Value user_copy(std::string const & user_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_user_copy, null, data.toStyledString(),
        null);
   ...
   * options 可选参数:
   */
  Json::Value user_delete(std::string const & group_id,
      std::string const & user_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_user_delete, null,
        data.toStyledString(), null);
   ...
   * options 可选参数:
   */
  Json::Value group_add(std::string const & group_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_group_add, null, data.toStyledString(),
        null);
   ...
   * options 可选参数:
   */
  Json::Value group_delete(std::string const & group_id,
      const std::map<std::string, std::string> & options) {
    Json::Value data;
    ...
    Json::Value result = this->request(_group_delete, null,
        data.toStyledString(), null);
  ...
  Json::Value group_getlist(
    ...
    Json::Value result = this->request(_group_getlist, null,
        data.toStyledString(), null);
   ...
   * liveness_control 活体检测控制  **NONE**: 不进行控制 **LOW**:较低的活体要求(高通过率 低攻击拒绝率) **NORMAL**: 一般的活体要求(平衡的攻击拒绝率, 通过率) **HIGH**: 较高的活体要求(高攻击拒绝率 低通过率) **默认NONE**
   */
  Json::Value person_verify(std::string const & image,
      std::string const & image_type, std::string const & id_card_number,
    ...
    Json::Value result = this->request(_person_verify, null,
        data.toStyledString(), null);
  ...
  Json::Value video_sessioncode(
    ...
    Json::Value result = this->request(_video_sessioncode, null,
        data.toStyledString(), null);
   ...
   *
   */
  Json::Value faceverify(Json::Value const & data) {
    std::string _faceverify =
        "https://aip.baidubce.com/rest/2.0/face/v3/faceverify";
    Json::Value result = this->request(_faceverify, null, data.toStyledString(),
        null);
   ...
   *
   */
  Json::Value match(Json::Value const & data) {
    std::string _match = "https://aip.baidubce.com/rest/2.0/face/v3/match";
    Json::Value result = this->request(_match, null, data.toStyledString(),
        null);
