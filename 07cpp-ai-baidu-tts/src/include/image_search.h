...
public:
  ...
  Imagesearch(const std::string & app_id, const std::string & ak,
      const std::string & sk) :
   ...
   */
  Json::Value same_hq_add(std::string const & image,
    ...
    Json::Value result = this->request(_same_hq_add, null, data, null);
   ...
   * rn 分页功能，截取条数，例：250
   */
  Json::Value same_hq_search(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_same_hq_search, null, data, null);
   ...
   * tags 1 - 65535范围内的整数，tag间以逗号分隔，最多2个tag。样例："100,11" ；检索时可圈定分类维度进行检索
   */
  Json::Value same_hq_update(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_same_hq_update, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value same_hq_delete_by_image(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_same_hq_delete, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value same_hq_delete_by_sign(std::string const & cont_sign,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
   ...
   * tags 1 - 65535范围内的整数，tag间以逗号分隔，最多2个tag。样例："100,11" ；检索时可圈定分类维度进行检索
   */
  Json::Value similar_add(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_similar_add, null, data, null);
   ...
   * rn 分页功能，截取条数，例：250
   */
  Json::Value similar_search(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_similar_search, null, data, null);
   ...
   * tags 1 - 65535范围内的整数，tag间以逗号分隔，最多2个tag。样例："100,11" ；检索时可圈定分类维度进行检索
   */
  Json::Value similar_update(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_similar_update, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value similar_delete_by_image(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_similar_delete, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value similar_delete_by_sign(std::string const & cont_sign,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
   ...
   */
  Json::Value product_add(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_product_add, null, data, null);
   ...
   * rn 分页功能，截取条数，例：250
   */
  Json::Value product_search(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_product_search, null, data, null);
  ...
  Json::Value product_update(std::string const & image,
    ...
    Json::Value result = this->request(_product_update, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value product_delete_by_image(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_product_delete, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value product_delete_by_sign(std::string const & cont_sign,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
