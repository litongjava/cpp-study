...
public:
  ...
  Kg(const std::string & app_id, const std::string & ak, const std::string & sk) :
   ...
   */
  Json::Value create_task(std::string const & name,
      std::string const & template_content,
      std::string const & input_mapping_file, std::string const & output_file,
    ...
    Json::Value result = this->request(_create_task, null, data, null);
   ...
   * output_file 输出文件名字
   */
  Json::Value update_task(const int & id,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_update_task, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value task_info(const int & id,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_task_info, null, data, null);
   ...
   * per_page 页码
   */
  Json::Value task_query(const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;

    std::copy(options.begin(), options.end(), std::inserter(data, data.end()));

    Json::Value result = this->request(_task_query, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value task_start(const int & id,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_task_start, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value task_status(const int & id,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_task_status, null, data, null);
