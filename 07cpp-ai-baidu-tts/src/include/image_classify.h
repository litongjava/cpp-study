...
public:
  ...
  Imageclassify(const std::string & app_id, const std::string & ak,
      const std::string & sk) :
   ...
   * options 可选参数:
   */
  Json::Value advanced_general(std::string const & image,
    ...
    Json::Value result = this->request(_advanced_general, null, data, null);
   ...
   */
  Json::Value dish_detect(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_dish_detect, null, data, null);
   ...
   * top_num 返回预测得分top结果数，默认为5
   */
  Json::Value car_detect(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_car_detect, null, data, null);
   ...
   */
  Json::Value logo_search(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_logo_search, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value logo_add(std::string const & image, std::string const & brief,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_logo_add, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value logo_delete_by_image(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_logo_delete, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value logo_delete_by_sign(std::string const & cont_sign,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
   ...
   */
  Json::Value animal_detect(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_animal_detect, null, data, null);
   ...
   * options 可选参数:
   */
  Json::Value plant_detect(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_plant_detect, null, data, null);
   ...
   */
  Json::Value object_detect(std::string const & image,
      const std::map<std::string, std::string> & options) {
    std::map<std::string, std::string> data;
    ...
    Json::Value result = this->request(_object_detect, null, data, null);
